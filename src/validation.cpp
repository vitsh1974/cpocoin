...
#if defined(NDEBUG)
# error "Cpocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Cpocoin Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Cpocoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
