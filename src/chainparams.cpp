...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.cpocoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("cpocointools.com", "dnsseed.cpocointools.com"));
        vSeeds.push_back(CDNSSeedData("cpocoinpool.org", "dnsseed.cpocoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("cpocointools.com", "testnet-seed.cpocointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.cpocoin.loshan.co.uk", true));
