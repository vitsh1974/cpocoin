...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cpocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cpocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cpocoin transaction") + "\n" +
              "  cpocoin-tx [options] -create [commands]   " + _("Create hex-encoded cpocoin transaction") + "\n" +
              "\n";
