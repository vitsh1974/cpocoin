...
const char * const BITCOIN_CONF_FILENAME = "cpocoin.conf";
const char * const BITCOIN_PID_FILENAME = "cpocoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cpocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cpocoin";
#else
    // Unix
    return pathRet / ".cpocoin";
#endif
#endif
}
